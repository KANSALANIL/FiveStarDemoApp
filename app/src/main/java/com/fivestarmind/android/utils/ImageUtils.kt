package com.fivestarmind.android.utils
...
class ImageUtils {
    ...
    fun fetchSVG(context: Context, url: String, target: ImageView,progressBar:ProgressBar) {
        ...
        if (httpClient == null) {
            ...
            httpClient =
                OkHttpClient.Builder().cache(Cache(context.cacheDir, 2 * 524 * 524) as Cache)
