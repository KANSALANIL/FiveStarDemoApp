...
import com.fivestarmind.android.mvp.model.response.ProgramDetailResponseModel
...
class ProductDetailPresenter(private val responseCallBack: ResponseCallBack) {

    private val TAG = ProductDetailPresenter::class.java.simpleName
    private var jObjError = JSONObject()
    private var error = ErrorResponse()

    interface ResponseCallBack {
        fun onResponseSuccess(response: ProgramDetailResponseModel)
    ...
    fun apiGetProductDetail(token: String, productId: String) {
        val apiService = ApiClient.client.create(ApiInterface::class.java)
        val call = apiService.productDetail(token, productId)

        call.enqueue(object : Callback<ProgramDetailResponseModel> {
            override fun onResponse(
                call: Call<ProgramDetailResponseModel>,
                response: Response<ProgramDetailResponseModel>
            ) {
                ...
                if (response.isSuccessful) {
                    ...
                    Log.d(TAG, "response Product Detail for Body = $myResponse")
                    ...
                    Log.d(TAG, "Json error  = $jObjError")
